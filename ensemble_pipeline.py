...
from ensemble.checkpoint_manager import (
...
def main() -> None:
    ...
    ensure_checkpoints_ready(args, datamodule_cls, subject_ids, seed_value)
    seed_dir_component = seed_folder_name(seed_value)
